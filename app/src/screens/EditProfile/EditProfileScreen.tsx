...
export const EditProfileScreen = () => {
    ...
    useEffect(() => {
        navigation.setOptions({
            headerRight: () => (<HeaderActionButton title={'SAVE'} onPress={() => {
                dispatch(updateProfile(userId, fullname, username, description, '', ''))
    ...
    return (<View>
        ...
        <ProfilePhoto profilePhotoUrl={userProfile.profilePhotoUrl} size={84} styles={{marginTop: -36, marginLeft: 16}}/>
        ...
        <TextInput style={styles.input} mode='outlined' label="Description" placeholder={'Description'} autoCorrect={false}
