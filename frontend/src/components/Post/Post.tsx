...
type Props = {
    ...
    loadPreviousComments: (postId: string, lastCommentId: string) => any;
...
const Post: React.FC<Props> = ({ postResponse, createComment, loadPreviousComments, likePost, dislikePost, displayImages, className }) => {
    ...
    const loadMoreComments = () => {
        const lastCommentId = postResponse.comments[0]
        console.log('lastcomment id=', lastCommentId);
        loadPreviousComments(postResponse.id, lastCommentId);
    };
